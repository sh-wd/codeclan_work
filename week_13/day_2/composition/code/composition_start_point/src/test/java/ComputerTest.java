...
public class ComputerTest {
    ...
    @Test
    public void canCheckForPrinter(){
        IOutput printer = new Printer("Epson", "Styles", 120, 4);
        System.out.println("Type " + printer.getClass());
        System.out.println(printer instanceof IOutput);
        assertEquals(120, ((Printer) printer).getDpi());
    }
}
